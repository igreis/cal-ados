...
export default function LandingPage() {
  ...
  return (
      ...
      <main className="flex-1 pt-16">
        <section id="home" className="flex sm:h-[50vh] justify-center bg-white">
          <div className="rounded-2xl mt-[50px] w-[1500px] bg-[yellow] flex md:flex-row flex-col justify-center items-center w-[1200px] gap-[5%] h-[350px] md:h-full">
